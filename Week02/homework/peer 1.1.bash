#!/bin/bash
# Correct Peer VPN working configuration file
...
# Client configuration sample 10.254.132.0/24,172.16.28.0/24 192.199.97.163:4282 /y6z1o8iyo+Jp2KFNByKbe7ysaR6nmYnwKGiU5Zq5BA= 8.8.8.8,1.1.1.1 1280 120 0.0.0.0/0"
